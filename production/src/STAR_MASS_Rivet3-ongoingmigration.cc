...
namespace Rivet {
  ...
  public:
	...
	nEvents = 1000000;//100; for testing
      ...
      // ---------------------
      fastjet::Selector select_track_eta = fastjet::SelectorAbsEtaMax(_max_track_eta);
      ...
      fastjet::Selector spart = select_track_eta * select_lopt * select_loptmax;
